    ...
    <div className="relative w-full h-96 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative w-80 h-80 rounded-full border border-cyan-400/30 bg-gradient-to-br from-cyan-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-xl">
        ...
        <div className="absolute inset-20 rounded-full flex items-center justify-center">
          <div className="relative">
            ...
            <div className="absolute inset-0 w-32 h-32 bg-cyan-400/10 rounded-full animate-pulse blur-md" style={{ animationDuration: '3s' }}></div>
            <div className="absolute inset-2 w-28 h-28 bg-purple-400/15 rounded-full animate-pulse blur-sm" style={{ animationDuration: '2.5s' }}></div>
            <div className="absolute inset-4 w-24 h-24 bg-pink-400/10 rounded-full animate-pulse blur-sm" style={{ animationDuration: '2s' }}></div>
            ...
            {/* Pulsing Core Halo */}
            <div className="absolute inset-8 w-16 h-16 bg-gradient-to-r from-cyan-400/20 via-purple-400/20 to-cyan-400/20 rounded-full animate-ping" style={{ animationDuration: '4s' }}></div>
          </div>
        </div>
      ...
      <div className="absolute top-4 left-4 space-y-2">
        <div className="flex items-center space-x-2 px-3 py-1 bg-black/30 rounded-lg border border-cyan-400/30 shadow-[0_0_15px_rgba(6,182,212,0.3)]">
          ...
          <span className="text-cyan-400 text-sm font-mono drop-shadow-[0_0_4px_rgba(6,182,212,0.6)]">NEURAL ACTIVE</span>
        </div>
        <div className="flex items-center space-x-2 px-3 py-1 bg-black/30 rounded-lg border border-purple-400/30 shadow-[0_0_15px_rgba(139,92,246,0.3)]">
          ...
          <span className="text-purple-400 text-sm font-mono drop-shadow-[0_0_4px_rgba(139,92,246,0.6)]">AI CORE ONLINE</span>
        </div>
      </div>

      {/* Corner Data Readouts with Halo Glow */}
      <div className="absolute top-4 right-4 text-right space-y-1">
        <div className="text-cyan-400 font-mono text-xs drop-shadow-[0_0_8px_rgba(6,182,212,0.6)]">PROC: 98.7%</div>
        <div className="text-purple-400 font-mono text-xs drop-shadow-[0_0_8px_rgba(139,92,246,0.6)]">MEM: 64.2GB</div>
        <div className="text-pink-400 font-mono text-xs drop-shadow-[0_0_8px_rgba(236,72,153,0.6)]">NET: 2.1GB/s</div>
      </div>
