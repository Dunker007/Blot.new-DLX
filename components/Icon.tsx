...
const library = {
    ...
    chip: (
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15-3.75H3m1.5-4.5V3m13.5 1.5v-1.5m3.75 4.5h1.5m-1.5 3.75h1.5M9 12a3 3 0 100-6 3 3 0 000 6zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    ),
    stop: (
...
const Icon: React.FC<IconProps> & { library: typeof library } = ({ name, className = 'w-6 h-6' }) => {
    return (
        <svg
